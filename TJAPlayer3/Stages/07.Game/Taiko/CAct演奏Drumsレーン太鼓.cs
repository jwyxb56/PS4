...
namespace TJAPlayer3
{
    internal class CAct演奏Drumsレーン太鼓 : CActivity
    {
        ...
        public override void On活性化()
        {
            ...
            this.t = new CCounter(0, 255, 5, TJAPlayer3.Timer);
        ...
        public override int On進行描画()
        {
            ...
            {
                TJAPlayer3.Tx.Lane_Background_Sub.t2D描画(TJAPlayer3.app.Device, 498, 490);
            ...
            {
                TJAPlayer3.Tx.Taiko_Frame[0].t2D描画(TJAPlayer3.app.Device, 0, 660);
            }
            var nTime = (long)(CSound管理.rc演奏用タイマ.n現在時刻 * (((double)TJAPlayer3.ConfigIni.n演奏速度) / 30.0));
        ...
        public void ゴーゴー炎()
        {
            ...
            {
                int nJudgeX = TJAPlayer3.Skin.Game_Lane_Field_X[0] - (195 / 2); //元の値は349なんだけど...
                ...
                TJAPlayer3.Tx.Judge_Frame.t2D描画(TJAPlayer3.app.Device, nJudgeX, nJudgeY, new Rectangle(0, 0, 195, 195));

                if (TJAPlayer3.stage演奏ドラム画面.bDoublePlay)
                    TJAPlayer3.Tx.Judge_Frame.t2D描画(TJAPlayer3.app.Device, nJudgeX, nJudgeY + 176, new Rectangle(0, 0, 195, 195));
            }
            ...
            for (int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++)
            {
                if (!this.st状態[i].ct進行.b停止中)
                {
                    ...
                    TJAPlayer3.Tx.Effects_Hit_Great_Big[this.st状態[i].ct進行.n現在の値].Opacity =  (255 - t.n現在の値) * 0xff / 100;
                    TJAPlayer3.Tx.Effects_Hit_Great[this.st状態[i].ct進行.n現在の値].Opacity = (255 - t.n現在の値) * 0xff / 100;
                    TJAPlayer3.Tx.Effects_Hit_Good_Big[this.st状態[i].ct進行.n現在の値].Opacity = (255 - t.n現在の値) * 0xff / 100;
                    TJAPlayer3.Tx.Effects_Hit_Good[this.st状態[i].ct進行.n現在の値].Opacity = (255 - t.n現在の値) * 0xff / 100;
                    ...
                    {
                        int nX = (TJAPlayer3.Skin.Game_Lane_Field_X[this.st状態[i].nPlayer]) - ((TJAPlayer3.Tx.Effects_Hit_Great[this.st状態[i].ct進行.n現在の値].sz画像サイズ.Width / 14) / 2);
                        int nY = (TJAPlayer3.Skin.Game_Lane_Field_Y[this.st状態[i].nPlayer]) + (195 / 2) - ((TJAPlayer3.Tx.Effects_Hit_Great[this.st状態[i].ct進行.n現在の値].sz画像サイズ.Height / 1) / 2);
                        ...
                        switch (st状態[i].judge)
                        {
                            ...
                            case E判定.Auto:
                                ...
                                if (this.st状態[i].nIsBig == 1 && TJAPlayer3.Tx.Effects_Hit_Great_Big[this.st状態[i].ct進行.n現在の値] != null)
                                    TJAPlayer3.Tx.Effects_Hit_Great_Big[this.st状態[i].ct進行.n現在の値].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Lane_Field_X[0] - TJAPlayer3.Tx.Effects_Hit_Great_Big[0].szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.Game_Lane_Field_Y[i] + (195 / 2) - TJAPlayer3.Tx.Effects_Hit_Great_Big[0].szテクスチャサイズ.Width / 2);
                                else if (TJAPlayer3.Tx.Effects_Hit_Great[this.st状態[i].ct進行.n現在の値] != null)
                                    TJAPlayer3.Tx.Effects_Hit_Great[this.st状態[i].ct進行.n現在の値].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Lane_Field_X[0] - TJAPlayer3.Tx.Effects_Hit_Great[0].szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.Game_Lane_Field_Y[i] + (195 / 2) - TJAPlayer3.Tx.Effects_Hit_Great[0].szテクスチャサイズ.Width / 2);
                                break;
                            ...
                            case E判定.Good:
                                ...
                                if (this.st状態[i].nIsBig == 1 && TJAPlayer3.Tx.Effects_Hit_Good_Big[this.st状態[i].ct進行.n現在の値] != null)
                                    TJAPlayer3.Tx.Effects_Hit_Good_Big[this.st状態[i].ct進行.n現在の値].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Lane_Field_X[0] - TJAPlayer3.Tx.Effects_Hit_Good_Big[0].szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.Game_Lane_Field_Y[i] + (195 / 2) - TJAPlayer3.Tx.Effects_Hit_Good_Big[0].szテクスチャサイズ.Width / 2);


                                else if (TJAPlayer3.Tx.Effects_Hit_Good[this.st状態[i].ct進行.n現在の値] != null)
                                    TJAPlayer3.Tx.Effects_Hit_Good[this.st状態[i].ct進行.n現在の値].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Lane_Field_X[0] - TJAPlayer3.Tx.Effects_Hit_Good[0].szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.Game_Lane_Field_Y[i] + (195 / 2) - TJAPlayer3.Tx.Effects_Hit_Good[0].szテクスチャサイズ.Width / 2);
                                break;
