...
namespace TJAPlayer3
{
    internal class CAct演奏Drums連打 : CActivity
    {
        ...
        {
            this.roll = new CCounter(0, 2, 140, TJAPlayer3.Timer);
        ...
        public int On進行描画( int n連打数, int player )
        {
            ...
            for( int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++ )
            {
                ...
                if ( this.ct連打枠カウンター[ player ].b終了値に達してない)
                {
                    ...
                    TJAPlayer3.Tx.Balloon_Roll.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Balloon_Roll_Frame_X[player], TJAPlayer3.Skin.Game_Balloon_Roll_Frame_Y[player], new Rectangle(0, 300 * this.roll.n現在の値, 615, 300));
