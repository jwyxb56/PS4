                ...
                if (st[i].b使用中)
                {
                    ...
                    switch (st[i].nプレイヤー)
                    {
                        case 0:
                            ...
                            TJAPlayer3.Tx.Notes?.t2D中心基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Effect_FlyingNotes_EndPoint_X[0], TJAPlayer3.Skin.Game_Effect_FlyingNotes_EndPoint_Y[0] + 50, new Rectangle(st[i].Lane * 195, 0, 195, 195));
                        ...
                        case 1:
                            ...
                            TJAPlayer3.Tx.Notes?.t2D中心基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Effect_FlyingNotes_EndPoint_X[1], TJAPlayer3.Skin.Game_Effect_FlyingNotes_EndPoint_Y[1], new Rectangle(st[i].Lane * 195, 0, 195, 195));
                            break;
                    }
