...
//		}
    ...
    //            this.tx魂花火 = CDTXMania.tテクスチャの生成( CSkin.Path( @"Graphics\7_explosion_soul.png" ) );
                ...
                this.F = new CCounter(0, 2, 80, TJAPlayer3.Timer);
                this.tenmetu = new CCounter(0, 40, 25, TJAPlayer3.Timer);
    ...
    //            }
		...
		public override int On進行描画()
		{
			if ( !base.b活性化してない )
			{
                ...
                this.R.t進行Loop();
                this.F.t進行Loop();
                int nRectX = (int)( this.db現在のゲージ値[ 0 ] / 2 ) * 18;
                int nRectX2P = (int)( this.db現在のゲージ値[ 1 ] / 2 ) * 18;
                ...
                */
                ...
                switch (ゲージモード)
                {
                    ...
                    case EGaugeMode.ExHard:
                        ...
                        {
                            TJAPlayer3.Tx.Gauge_ExHard[0].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0], new Rectangle(0, 0, nRectX, 66));
                        ...
                        {
                            TJAPlayer3.Tx.Gauge_Hard[0].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0], new Rectangle(0, 0, nRectX, 66));
                            if (TJAPlayer3.Tx.Gauge_Line_Hard[0] != null)
                                TJAPlayer3.Tx.Gauge_Line_Hard[0].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0]);
                            else if (TJAPlayer3.Tx.Gauge_Line[0] != null)
                                TJAPlayer3.Tx.Gauge_Line[0].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0]);
                        ...
                        {
                            TJAPlayer3.Tx.Gauge[0].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0], new Rectangle(0, 0, nRectX, 66));
                    ...
                    default:
                        ...
                        if (TJAPlayer3.Tx.Gauge_Base[0] != null)
                            TJAPlayer3.Tx.Gauge_Base[0].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0], new Rectangle(0, 0, 903, 51));
                        if (TJAPlayer3.stage演奏ドラム画面.bDoublePlay)
                        {
                            if (TJAPlayer3.Tx.Gauge_Base[1] != null)
                                TJAPlayer3.Tx.Gauge_Base[1].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[1], TJAPlayer3.Skin.Game_Gauge_Y[1], new Rectangle(0, 0, 903, 51));
                        }
                        #endregion
                        #region ゲージ1P
                        ...
                        {
                            if (TJAPlayer3.Tx.Gauge[0] != null)
                                TJAPlayer3.Tx.Gauge[0].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0], new Rectangle(0, 0, nRectX, 51));
                            if (TJAPlayer3.Tx.Gauge_Line[0] != null)
                            {
                                if (TJAPlayer3.ConfigIni.eGaugeMode == EGaugeMode.Normal && this.db現在のゲージ値[0] >= 100.0)
                                {
                                    if (TJAPlayer3.Tx.Gauge_Rainbow != null)
                                    {
                                        TJAPlayer3.Tx.Gauge_Rainbow.Opacity = 255;
                                        TJAPlayer3.Tx.Gauge_Rainbow.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0] + 17, new Rectangle(0, 34 * this.R.n現在の値, 704, 34));
                                        TJAPlayer3.Tx.Gauge_Rainbow.Opacity = (ct虹透明度.n現在の値 * 255 / ct虹透明度.n終了値) / 1;
                                        TJAPlayer3.Tx.Gauge_Rainbow.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0] + 17, new Rectangle(0, 34 * this.R.n現在の値, 704, 34));
                                        TJAPlayer3.Tx.Gauge_RainbowC.Opacity = 255;
                                        TJAPlayer3.Tx.Gauge_RainbowC.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0] + 704, TJAPlayer3.Skin.Game_Gauge_Y[0], new Rectangle(0, 51 * this.R.n現在の値, 199, 51));
                                        TJAPlayer3.Tx.Gauge_RainbowC.Opacity = (ct虹透明度.n現在の値 * 255 / ct虹透明度.n終了値) / 1;
                                        TJAPlayer3.Tx.Gauge_RainbowC.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Gauge_X[0] + 704, TJAPlayer3.Skin.Game_Gauge_Y[0], new Rectangle(0, 51 * this.R.n現在の値, 199, 51));
                            ...
                            {
                                TJAPlayer3.Tx.Gauge[0].t2D描画(TJAPlayer3.app.Device, 818 + TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0], new Rectangle(0, 51, 100, 35));
                            }
                            else
                            {
                                TJAPlayer3.Tx.Gauge[0].t2D描画(TJAPlayer3.app.Device, 818 + TJAPlayer3.Skin.Game_Gauge_X[0], TJAPlayer3.Skin.Game_Gauge_Y[0], new Rectangle(100, 51, 100, 35));
                            }
                                    ...
                                    if (TJAPlayer3.Tx.Gauge_Soul_Fire != null)
                {
                    ...
                    for (int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++)
                    {
                        ...
                        {
                            this.ct炎.t進行Loop();
                            TJAPlayer3.Tx.Gauge_Soul_Fire.t2D描画(TJAPlayer3.app.Device, 1727, 100, new Rectangle(250 * (this.ct炎.n現在の値), 0, 250, 250));
                        }
                    }
                }
                if (TJAPlayer3.Tx.Gauge_Soul != null)
                {
                    ...
                    for (int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++)
                    {
                        ...
                        {
                            TJAPlayer3.Tx.Gauge_Soul.Opacity = 255;
                            TJAPlayer3.Tx.Gauge_Soul.t2D描画(TJAPlayer3.app.Device, 1727, 160, new Rectangle(0, 120, 117, 120));
                        }
                        else
                        {
                            TJAPlayer3.Tx.Gauge_Soul.Opacity = 255;
                            TJAPlayer3.Tx.Gauge_Soul.t2D描画(TJAPlayer3.app.Device, 1727, 160, new Rectangle(0, 0, 117, 120));
                        }
                        if (TJAPlayer3.Tx.Gauge_Soul != null)
                        {
                            this.tenmetu.t進行Loop();
                            int c = 0;

                            if (this.tenmetu.n現在の値 <= 20)
                            {
                                c = 40 + tenmetu.n現在の値;
                            }
                            else
                            ...
                            TJAPlayer3.Tx.Gauge_Soul.Opacity = ((c * 0xff) / 100);
                            TJAPlayer3.Tx.Gauge_Soul.t2D描画(TJAPlayer3.app.Device, 1729, 162, new Rectangle(0, 240, 117, 120));
                        }
                    }
                }
