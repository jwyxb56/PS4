                ...
                for (int i = 0; i < 128; i++)
                {
                    if (Flying[i].IsUsing)
                    {
                        ...
                        for (int n = Flying[i].OldValue; n < Flying[i].Counter.n現在の値; n++)
                        {
                            ...
                            {
                                Flying[i].X = (Flying[i].StartPointX + 705 + ((-Math.Cos(Flying[i].Counter.n現在の値 * (Math.PI / 180)) * 734))) - 127;
                            ...
                            {
                                Flying[i].Y = ((TJAPlayer3.Skin.Game_Effect_FlyingNotes_StartPoint_Y[Flying[i].Player]) + -Math.Sin(Flying[i].Counter.n現在の値 * (Math.PI / 180)) * 825) + 493;
                        ...
                        if (Flying[i].Player == 0)
                        {
                            TJAPlayer3.Tx.Notes?.t2D中心基準描画(TJAPlayer3.app.Device, (int)Flying[i].X, (int)Flying[i].Y, new Rectangle(Flying[i].Lane * 195, 0, 195, 195));
                        }
