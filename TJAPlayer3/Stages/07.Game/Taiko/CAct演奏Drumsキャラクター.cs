...
namespace TJAPlayer3
{
    ...
    internal class CAct演奏Drumsキャラクター : CActivity
    {
        ...
        public override void OnManagedリソースの作成()
        {
            ...
            this.ClearM = new CCounter(0, 200, 6, TJAPlayer3.Timer);
        ...
        {
            TJAPlayer3.Tx.Chara_Normal[this.arモーション番号[(int)this.ctChara_Normal.db現在の値]].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_Normal[this.arモーション番号[(int)this.ctChara_Normal.db現在の値]].vc拡大縮小倍率.Y = 1.41f;
            TJAPlayer3.Tx.Chara_Normal_Cleared[this.arクリアモーション番号[(int)this.ctChara_Clear.db現在の値]].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_Normal_Cleared[this.arクリアモーション番号[(int)this.ctChara_Clear.db現在の値]].vc拡大縮小倍率.Y = 1.41f;
            TJAPlayer3.Tx.Chara_Normal_Maxed[this.arクリアモーション番号[(int)this.ctChara_Clear.db現在の値]].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_Normal_Maxed[this.arクリアモーション番号[(int)this.ctChara_Clear.db現在の値]].vc拡大縮小倍率.Y = 1.41f;
            TJAPlayer3.Tx.Chara_GoGoTime_Maxed[this.arモーション番号[(int)this.ctChara_Normal.db現在の値]].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_GoGoTime_Maxed[this.arモーション番号[(int)this.ctChara_Normal.db現在の値]].vc拡大縮小倍率.Y = 1.41f;
            TJAPlayer3.Tx.Chara_GoGoTime[this.arゴーゴーモーション番号[(int)this.ctChara_GoGo.db現在の値]].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_GoGoTime[this.arゴーゴーモーション番号[(int)this.ctChara_GoGo.db現在の値]].vc拡大縮小倍率.Y = 1.41f;
            TJAPlayer3.Tx.Chara_10Combo_Maxed[(int)this.ctキャラクターアクション_10コンボMAX.db現在の値].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_10Combo_Maxed[(int)this.ctキャラクターアクション_10コンボMAX.db現在の値].vc拡大縮小倍率.Y = 1.41f;
            TJAPlayer3.Tx.Chara_10Combo[(int)this.ctキャラクターアクション_10コンボ.db現在の値].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_10Combo[(int)this.ctキャラクターアクション_10コンボ.db現在の値].vc拡大縮小倍率.Y = 1.41f;
            TJAPlayer3.Tx.Chara_GoGoStart[(int)this.ctキャラクターアクション_ゴーゴースタート.db現在の値].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_GoGoStart[(int)this.ctキャラクターアクション_ゴーゴースタート.db現在の値].vc拡大縮小倍率.Y = 1.41f;
            TJAPlayer3.Tx.Chara_GoGoStart_Maxed[(int)this.ctキャラクターアクション_ゴーゴースタートMAX.db現在の値].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_GoGoStart_Maxed[(int)this.ctキャラクターアクション_ゴーゴースタートMAX.db現在の値].vc拡大縮小倍率.Y = 1.41f;
            TJAPlayer3.Tx.Chara_Become_Cleared[(int)this.ctキャラクターアクション_ノルマ.db現在の値].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_Become_Cleared[(int)this.ctキャラクターアクション_ノルマ.db現在の値].vc拡大縮小倍率.Y = 1.41f;
            TJAPlayer3.Tx.Chara_Become_Maxed[(int)this.ctキャラクターアクション_魂MAX.db現在の値].vc拡大縮小倍率.X = 1.41f;
            TJAPlayer3.Tx.Chara_Become_Maxed[(int)this.ctキャラクターアクション_魂MAX.db現在の値].vc拡大縮小倍率.Y = 1.41f;
            {
                    ...
                    if (!TJAPlayer3.stage演奏ドラム画面.bIsGOGOTIME[0])
                    {
                        if (TJAPlayer3.stage演奏ドラム画面.actGauge.db現在のゲージ値[0] >= 100.0 && TJAPlayer3.Skin.Game_Chara_Ptn_Clear != 0 && TJAPlayer3.ConfigIni.eGaugeMode != EGaugeMode.Hard && TJAPlayer3.ConfigIni.eGaugeMode != EGaugeMode.ExHard)
                        {
                            if (TJAPlayer3.Skin.Game_Chara_Ptn_Clear != 0)
                                TJAPlayer3.Tx.Chara_Normal_Maxed[this.arクリアモーション番号[(int)this.ctChara_Clear.db現在の値]].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                        }
                        else if (TJAPlayer3.stage演奏ドラム画面.actGauge.db現在のゲージ値[0] >= 80.0 && TJAPlayer3.Skin.Game_Chara_Ptn_Clear != 0 && TJAPlayer3.ConfigIni.eGaugeMode != EGaugeMode.Hard && TJAPlayer3.ConfigIni.eGaugeMode != EGaugeMode.ExHard)
                        {
                            if (TJAPlayer3.Skin.Game_Chara_Ptn_Clear != 0)
                            {
                                TJAPlayer3.Tx.Chara_Normal_Cleared[this.arクリアモーション番号[(int)this.ctChara_Clear.db現在の値]].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                            }
                        }
                        else
                        {
                            ...
                            {
                                TJAPlayer3.Tx.Chara_Normal[this.arモーション番号[(int)this.ctChara_Normal.db現在の値]].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                            }
                        }
                    }
                    else
                    {
                        if (TJAPlayer3.stage演奏ドラム画面.actGauge.db現在のゲージ値[0] >= 100.0 && TJAPlayer3.Skin.Game_Chara_Ptn_GoGo != 0 && TJAPlayer3.ConfigIni.eGaugeMode != EGaugeMode.Hard && TJAPlayer3.ConfigIni.eGaugeMode != EGaugeMode.ExHard)
                        {
                            if (TJAPlayer3.Skin.Game_Chara_Ptn_GoGo != 0)
                                TJAPlayer3.Tx.Chara_GoGoTime_Maxed[this.arゴーゴーモーション番号[(int)this.ctChara_GoGo.db現在の値]].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                        }
                        else
                        {
                            if (TJAPlayer3.Skin.Game_Chara_Ptn_GoGo != 0)
                                TJAPlayer3.Tx.Chara_GoGoTime[this.arゴーゴーモーション番号[(int)this.ctChara_GoGo.db現在の値]].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                        }
                    }
                }
                ...
                if (this.b風船連打中 != true && bマイどんアクション中 == true && CharaAction_Balloon_Delay.b終了値に達した)
                {
                    ...
                    if (this.ctキャラクターアクション_10コンボ.b進行中db)
                    {
                        ...
                        {
                            TJAPlayer3.Tx.Chara_10Combo[(int)this.ctキャラクターアクション_10コンボ.db現在の値].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                        }
                    ...
                    if (this.ctキャラクターアクション_10コンボMAX.b進行中db)
                    {
                        ...
                        {
                            TJAPlayer3.Tx.Chara_10Combo_Maxed[(int)this.ctキャラクターアクション_10コンボMAX.db現在の値].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                        }
                    ...
                    if (this.ctキャラクターアクション_ゴーゴースタート.b進行中db)
                    {
                        ...
                        {
                            TJAPlayer3.Tx.Chara_GoGoStart[(int)this.ctキャラクターアクション_ゴーゴースタート.db現在の値].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                        }
                    ...
                    if (this.ctキャラクターアクション_ゴーゴースタートMAX.b進行中db)
                    {
                        ...
                        {
                            TJAPlayer3.Tx.Chara_GoGoStart_Maxed[(int)this.ctキャラクターアクション_ゴーゴースタートMAX.db現在の値].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                        }
                    ...
                    if (this.ctキャラクターアクション_ノルマ.b進行中db)
                    {
                        ...
                        {
                            TJAPlayer3.Tx.Chara_Become_Cleared[(int)this.ctキャラクターアクション_ノルマ.db現在の値].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                        }
                    ...
                    if (this.ctキャラクターアクション_魂MAX.b進行中db)
                    {
                        ...
                        {
                            TJAPlayer3.Tx.Chara_Become_Maxed[(int)this.ctキャラクターアクション_魂MAX.db現在の値].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_X[0], TJAPlayer3.Skin.Game_Chara_Y[0]);
                        }
                ...
                if (TJAPlayer3.stage演奏ドラム画面.bIsAlreadyMaxed[0] && TJAPlayer3.ConfigIni.eGaugeMode != EGaugeMode.Hard && TJAPlayer3.ConfigIni.eGaugeMode != EGaugeMode.ExHard != CharaAction_Balloon_Breaking?.b進行中 == true)
                {
                    this.ClearM.t進行Loop();
                    int m = 0;

                    if (this.ClearM.n現在の値 <= 100)
                    {
                        m = 50 + ClearM.n現在の値;
                    }
                    else
                    ...
                    {
                        TJAPlayer3.Tx.Clear_Maxed.Opacity = ((m * 0xff) / 100);
                        TJAPlayer3.Tx.Clear_Maxed.t2D描画(TJAPlayer3.app.Device, 60, -10);
                    }
                }
            ...
            if (bマイどんアクション中)
            {
                ...
                if (CharaAction_Balloon_Broke?.b進行中 == true && TJAPlayer3.Skin.Game_Chara_Ptn_Balloon_Broke != 0)
                {
                    ...
                    if(TJAPlayer3.Tx.Chara_Balloon_Broke[CharaAction_Balloon_Broke.n現在の値] != null)
                    {
                        ...
                        TJAPlayer3.Tx.Chara_Balloon_Broke[CharaAction_Balloon_Broke.n現在の値].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_Balloon_X[0], TJAPlayer3.Skin.Game_Chara_Balloon_Y[0]);
                    }
                ...
                else if (CharaAction_Balloon_Miss?.b進行中 == true && TJAPlayer3.Skin.Game_Chara_Ptn_Balloon_Miss != 0)
                {
                    ...
                    if(TJAPlayer3.Tx.Chara_Balloon_Miss[CharaAction_Balloon_Miss.n現在の値] != null)
                    {
                        ...
                        TJAPlayer3.Tx.Chara_Balloon_Miss[CharaAction_Balloon_Miss.n現在の値].t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_Balloon_X[0], TJAPlayer3.Skin.Game_Chara_Balloon_Y[0]);
                    }
                    TJAPlayer3.stage演奏ドラム画面.PuchiChara.On進行描画(TJAPlayer3.Skin.Game_PuchiChara_BalloonX[0], TJAPlayer3.Skin.Game_PuchiChara_BalloonY[0], false, nowOpacity, true);
                ...
                {
                    TJAPlayer3.Tx.Chara_Balloon_Breaking[CharaAction_Balloon_Breaking.n現在の値]?.t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Chara_Balloon_X[0], TJAPlayer3.Skin.Game_Chara_Balloon_Y[0]);
