	...
	internal class CAct演奏判定文字列共通 : CActivity
	{
		...
		public CAct演奏判定文字列共通()
		{
			...
			Rectangle[] r = new Rectangle[] {
				new Rectangle( 0, 0,    135, 90 ),		// Perfect
				new Rectangle( 0, 0,    135, 90 ),		// Great
				new Rectangle( 0, 90,   135, 90 ),		// Good
				new Rectangle( 0, 180,   135, 90 ),		// Poor
				new Rectangle( 0, 180,   135, 90 ),		// Miss
				new Rectangle( 0, 270,   135, 90 ),		// Bad
				new Rectangle( 0, 0,    135, 90 )		// Auto
			};
			for ( int i = 0; i < 7; i++ )
			{
			...
			for ( int i = 0; i < 12; i++ )
			{
				...
				this.stLag数値[ i + 12 ].rc = new Rectangle( ( i % 4 ) * 15 + 80, ( i / 4 ) * 19 + 80, 15, 19 );	// minus numbers
			}
			base.b活性化してない = true;
		}
