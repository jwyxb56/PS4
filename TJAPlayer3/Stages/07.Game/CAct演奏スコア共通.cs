...
namespace TJAPlayer3
{
	internal class CAct演奏スコア共通 : CActivity
	{
        ...
        public CCounter ctスコアランク表示;
        public CCounter ctスコアランク表示1;
                        ...
                        switch( mode )
                        {
                            ...
                            case 1:
                                if(TJAPlayer3.Tx.Taiko_Score[1] != null )
                                {
                                    ...
                                    TJAPlayer3.Tx.Taiko_Score[1].vc拡大縮小倍率.X = 0.75f;
                                    TJAPlayer3.Tx.Taiko_Score[1].vc拡大縮小倍率.Y = 0.75f;
                                    TJAPlayer3.Tx.Taiko_Score[1].t2D拡大率考慮下基準描画( TJAPlayer3.app.Device, x, y, rectangle );
                                    x += TJAPlayer3.Skin.Game_Score_Padding - 40;
                                }
                                break;
                            case 2:
