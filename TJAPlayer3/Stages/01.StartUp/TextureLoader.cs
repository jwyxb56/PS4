...
namespace TJAPlayer3
{
    class TextureLoader
    {
        ...
        public void LoadTexture()
        {
            ...
            SongSelect_Sc = TxC(SONGSELECT + @"Sc.png");
            ...
            if (SongLoading_Plate != null) SongLoading_Plate.b加算合成 = TJAPlayer3.Skin.Game_Effect_HitExplosion_AddBlend;
            SongLoading_FadeIn = TxC(SONGLOADING + @"FadeIn.png");
            for (int i = 0; i < SongLoading_FadeOut.Length; i++)
            {
                SongLoading_FadeOut[i] = TxC(SONGLOADING + @"FadeOut_" + i.ToString() + ".png");
            }
            for (int i = 0; i < SongLoading_r.Length; i++)
            {
                SongLoading_r[i] = TxC(SONGLOADING + @"LoadingNow\" + @"r_" + i.ToString() + ".png");
            }
            ...
            #endregion
            #region キャラクター
            Clear_Maxed = TxC(GAME + CHARA + @"Clear_Maxed.png");
            if (Clear_Maxed != null) Clear_Maxed.b加算合成 = TJAPlayer3.Skin.Game_Effect_HitExplosion_AddBlend;
            ...
            #endregion
            #region モブ
            TJAPlayer3.Skin.Game_Mob_Ptn = TJAPlayer3.t連番画像の枚数を数える(CSkin.Path(BASE + GAME + MOB + @"Ptn0_"));
            ...
            Background_Down2 = TxC(GAME + BACKGROUND + @"0\" + @"Down2.png");
            if (Background_Down2 != null) Background_Down2.b加算合成 = TJAPlayer3.Skin.Game_Effect_HitExplosion_AddBlend;
            Background_Down_Clear = TxC(GAME + BACKGROUND + @"0\" + @"Down_Clear.png");
            for (int i = 0; i < Background_Down.Length; i++)
            {
                Background_Down[i] = TxC(GAME + BACKGROUND + @"0\" + @"Down_" + i.ToString() + ".png");
            }
            for (int i = 0; i < Background_DownC.Length; i++)
            {
                Background_DownC[i] = TxC(GAME + BACKGROUND + @"0\" + @"Down_C_" + i.ToString() + ".png");
            }
            #endregion
            #region 太鼓
            ...
            Taiko_Combo[2] = TxC(GAME + TAIKO + @"Combo_Big1.png");
            Taiko_Combo[3] = TxC(GAME + TAIKO + @"Combo_Big2.png");
            Taiko_Combo_Effect = TxC(GAME + TAIKO + @"Combo_Effect.png");
            Taiko_Combo_Text = TxC(GAME + TAIKO + @"Combo_Text.png");
            Taiko_Auto = TxC(GAME + TAIKO + @"Auto.png");
            Taiko_ScoreRanks = TxC(GAME + TAIKO + @"ScoreRanks.png");
            #endregion
            #region ゲージ
            ...
            Gauge_Rainbow = TxC(GAME + GAUGE + @"Rainbow\" + "R.png");
            Gauge_RainbowC = TxC(GAME + GAUGE + @"Rainbow\" + "Rc.png");
            ...
            {
                Effects_Hit_Good[i] = TxC(GAME + EFFECTS + @"Hit\" + @"Good.png");
                Effects_Hit_Good_Big[i] = TxC(GAME + EFFECTS + @"Hit\" + @"GoodBig.png");
                Effects_Hit_Great[i] = TxC(GAME + EFFECTS + @"Hit\" + @"Great.png");
                Effects_Hit_Great_Big[i] = TxC(GAME + EFFECTS + @"Hit\" + @"GreatBig.png");
            }
            ...
            #endregion
            #region 終了演出
            for (int i = 0; i < End_AnClear_L.Length; i++)
            {
                End_AnClear_L[i] = TxC(GAME + END + @"AnClear\" + @"Clear_L_" + i.ToString() + ".png");
                End_AnClear_R[i] = TxC(GAME + END + @"AnClear\" + @"Clear_R_" + i.ToString() + ".png");
            }
            ...
            for (int i = 0; i < End_fClear_L.Length; i++)
            {
                End_fClear_L[i] = TxC(GAME + END + @"fClear\" + @"Clear_L_" + i.ToString() + ".png");
                End_fClear_R[i] = TxC(GAME + END + @"fClear\" + @"Clear_R_" + i.ToString() + ".png");
            }
            End_Clear_Text = TxC(GAME + END + @"Clear\" + @"Clear_Text.png");
            for (int i = 0; i < End_AnClear_Text.Length; i++)
            {
                End_AnClear_Text[i] = TxC(GAME + END + @"AnClear\" + @"AnClear_Text_" + i.ToString() + ".png");
            }
            for (int i = 0; i < End_fClear_Text.Length; i++)
            {
                End_fClear_Text[i] = TxC(GAME + END + @"fClear\" + @"fClear_Text_" + i.ToString() + ".png");
            }
            for (int i = 0; i < End_dClear_Text.Length; i++)
            {
                End_dClear_Text[i] = TxC(GAME + END + @"dClear\" + @"dClear_Text_" + i.ToString() + ".png");
            }
            ...
            Result_Speak = TxC(RESULT + @"Speak.png");
            for (int i = 0; i < Result_Chara.Length; i++)
            {
                Result_Chara[i] = TxC(RESULT + @"Chara_" + i.ToString() + ".png");
            }
            #endregion
        ...
        public void DisposeTexture()
        {
            ...
            TJAPlayer3.t安全にDisposeする(ref SongSelect_Sc);
            ...
            TJAPlayer3.t安全にDisposeする(SongSelect_Bar_Center);
            ...
            TJAPlayer3.t安全にDisposeする(SongLoading_FadeOut);
            TJAPlayer3.t安全にDisposeする(SongLoading_r);
            #endregion

            #region 5_演奏画面
            #region 共通
            TJAPlayer3.t安全にDisposeする(ref Notes);
            TJAPlayer3.t安全にDisposeする(ref Notesf);
            ...
            #endregion
            #region キャラクター
            TJAPlayer3.t安全にDisposeする(ref Clear_Maxed);
            ...
            TJAPlayer3.t安全にDisposeする(ref Background_Down2);
            TJAPlayer3.t安全にDisposeする(ref Background_Down_Clear);
            TJAPlayer3.t安全にDisposeする(Background_DownC);
            #endregion
            #region 太鼓
            ...
            TJAPlayer3.t安全にDisposeする(ref Taiko_Auto);
            TJAPlayer3.t安全にDisposeする(ref Taiko_ScoreRanks);
            #endregion
            #region ゲージ
            ...
            TJAPlayer3.t安全にDisposeする(ref Gauge_RainbowC);
            ...
            #endregion
            #region 終了演出
            TJAPlayer3.t安全にDisposeする(End_AnClear_L);
            TJAPlayer3.t安全にDisposeする(End_AnClear_R);
            TJAPlayer3.t安全にDisposeする(End_Clear_L);
            TJAPlayer3.t安全にDisposeする(End_Clear_R);
            TJAPlayer3.t安全にDisposeする(End_fClear_L);
            TJAPlayer3.t安全にDisposeする(End_fClear_R);
            TJAPlayer3.t安全にDisposeする(ref End_Clear_Text);
            TJAPlayer3.t安全にDisposeする(End_AnClear_Text);
            TJAPlayer3.t安全にDisposeする(End_fClear_Text);
            TJAPlayer3.t安全にDisposeする(End_dClear_Text);
            ...
            TJAPlayer3.t安全にDisposeする(Result_Chara);
            TJAPlayer3.t安全にDisposeする(ref Result_Speak);
            #endregion
        ...
        public readonly CTexture[] SongSelect_Bar_Center = new CTexture[9];
        ...
        public CTexture SongLoading_Plate,
            SongLoading_FadeIn,
            SongLoading_Fade;
        public readonly CTexture[] SongLoading_FadeOut = new CTexture[9];
        public readonly CTexture[] SongLoading_r = new CTexture[9];
        #endregion
        ...
        public readonly CTexture[] Background_DownC = new CTexture[15];
        public readonly CTexture[] Background_Down = new CTexture[15];
        #endregion
        #region 太鼓
        ...
        public readonly CTexture[] Taiko_Combo = new CTexture[4];
        #endregion
        #region ゲージ
        ...
        public CTexture Gauge_RainbowC;
        ...
        #endregion
        #region 終了演出
        public readonly CTexture[] End_AnClear_L = new CTexture[5];
        public readonly CTexture[] End_AnClear_R = new CTexture[5];
        public readonly CTexture[] End_Clear_L = new CTexture[5];
        public readonly CTexture[] End_Clear_R = new CTexture[5];
        public readonly CTexture[] End_fClear_L = new CTexture[5];
        public readonly CTexture[] End_fClear_R = new CTexture[5];
        public CTexture End_Clear_Text,
            End_Clear_Text_Effect;
        public readonly CTexture[] End_AnClear_Text = new CTexture[10];
        public readonly CTexture[] End_fClear_Text = new CTexture[10];
        public readonly CTexture[] End_dClear_Text = new CTexture[10];
        #endregion
        #region ゲームモード
        ...
        public CTexture Result_Background,
            ...
            Result_Speak,
            Result_Dan;
        public readonly CTexture[] Result_Chara = new CTexture[4];
        #endregion
