	...
	internal class CStage曲読み込み : CStage
	{
		...
		public override void OnManagedリソースの作成()
		{
			if( !base.b活性化してない )
			{
                ...
                this.ct待機 = new CCounter( 0, 1000, 5, TJAPlayer3.Timer );
                this.ct曲名表示 = new CCounter( 1, 30, 30, TJAPlayer3.Timer );
				this.桜 = new CCounter(1, 5, 150, TJAPlayer3.Timer);
				try
				{
		...
		public override int On進行描画()
		{
			...
			if (this.txタイトル != null)
			{
				...
				{
					this.txタイトル.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.SongLoading_Title_XY[0], TJAPlayer3.Skin.SongLoading_Title_XY[1] + 75 - (this.txタイトル.sz画像サイズ.Height / 2) + nサブタイトル補正);
				}
				else if (TJAPlayer3.Skin.SongLoading_Title_ReferencePoint == CSkin.ReferencePoint.Right)
				{
					this.txタイトル.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.SongLoading_Title_XY[0] - (this.txタイトル.sz画像サイズ.Width * txタイトル.vc拡大縮小倍率.X), TJAPlayer3.Skin.SongLoading_Title_XY[1] + 75 - (this.txタイトル.sz画像サイズ.Height / 2) + nサブタイトル補正);
				}
				else
				{
					this.txタイトル.t2D描画(TJAPlayer3.app.Device, (TJAPlayer3.Skin.SongLoading_Title_XY[0] - ((this.txタイトル.sz画像サイズ.Width * txタイトル.vc拡大縮小倍率.X) / 2)), TJAPlayer3.Skin.SongLoading_Title_XY[1] + 75 - (this.txタイトル.sz画像サイズ.Height / 2) + nサブタイトル補正);
				}
			}
			if (this.txサブタイトル != null)
			{
				...
				{
					this.txサブタイトル.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.SongLoading_SubTitle_XY[0], TJAPlayer3.Skin.SongLoading_SubTitle_XY[1] + 50 - (this.txサブタイトル.sz画像サイズ.Height / 2));
				}
				else if (TJAPlayer3.Skin.SongLoading_Title_ReferencePoint == CSkin.ReferencePoint.Right)
				{
					this.txサブタイトル.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.SongLoading_SubTitle_XY[0] - (this.txサブタイトル.sz画像サイズ.Width * txタイトル.vc拡大縮小倍率.X), TJAPlayer3.Skin.SongLoading_SubTitle_XY[1] + 50 - (this.txサブタイトル.sz画像サイズ.Height / 2));
				}
				else
				{
					this.txサブタイトル.t2D描画(TJAPlayer3.app.Device, (TJAPlayer3.Skin.SongLoading_SubTitle_XY[0] - ((this.txサブタイトル.sz画像サイズ.Width * txサブタイトル.vc拡大縮小倍率.X) / 2)), TJAPlayer3.Skin.SongLoading_SubTitle_XY[1] + 50 - (this.txサブタイトル.sz画像サイズ.Height / 2));
				}
			}
			...
			this.桜.t進行Loop();
			if (TJAPlayer3.Tx.SongLoading_r != null)
            {
				TJAPlayer3.Tx.SongLoading_r[5].t2D描画(TJAPlayer3.app.Device, 1797, 972);
				if(this.桜.n現在の値 == 1)
                {
					TJAPlayer3.Tx.SongLoading_r[0].Opacity = 255;
					TJAPlayer3.Tx.SongLoading_r[0].t2D描画(TJAPlayer3.app.Device, 1818, 975);
					TJAPlayer3.Tx.SongLoading_r[4].Opacity = 150;
					TJAPlayer3.Tx.SongLoading_r[4].t2D描画(TJAPlayer3.app.Device, 1801, 987);
				}
				if (this.桜.n現在の値 == 2)
				{
					TJAPlayer3.Tx.SongLoading_r[1].Opacity = 255;
					TJAPlayer3.Tx.SongLoading_r[1].t2D描画(TJAPlayer3.app.Device, 1831, 987);
					TJAPlayer3.Tx.SongLoading_r[0].Opacity = 150;
					TJAPlayer3.Tx.SongLoading_r[0].t2D描画(TJAPlayer3.app.Device, 1818, 975);
				}
				if (this.桜.n現在の値 == 3)
				{
					TJAPlayer3.Tx.SongLoading_r[2].Opacity = 255;
					TJAPlayer3.Tx.SongLoading_r[2].t2D描画(TJAPlayer3.app.Device, 1828, 1004);
					TJAPlayer3.Tx.SongLoading_r[1].Opacity = 150;
					TJAPlayer3.Tx.SongLoading_r[1].t2D描画(TJAPlayer3.app.Device, 1831, 987);
				}
				if (this.桜.n現在の値 == 4)
				{
					TJAPlayer3.Tx.SongLoading_r[3].Opacity = 255;
					TJAPlayer3.Tx.SongLoading_r[3].t2D描画(TJAPlayer3.app.Device, 1807, 1005);
					TJAPlayer3.Tx.SongLoading_r[2].Opacity = 150;
					TJAPlayer3.Tx.SongLoading_r[2].t2D描画(TJAPlayer3.app.Device, 1828, 1004);
				}
				if (this.桜.n現在の値 == 5)
				{
					TJAPlayer3.Tx.SongLoading_r[4].Opacity = 255;
					TJAPlayer3.Tx.SongLoading_r[4].t2D描画(TJAPlayer3.app.Device, 1801, 987);
					TJAPlayer3.Tx.SongLoading_r[3].Opacity = 150;
					TJAPlayer3.Tx.SongLoading_r[3].t2D描画(TJAPlayer3.app.Device, 1807, 1005);
				}
				TJAPlayer3.Tx.SongLoading_r[6].t2D描画(TJAPlayer3.app.Device, 1647, 987);
