...
//			this.nASIOBufferSizeMs = 0;					// #24820 2012.12.25 yyagi 初期値は0(自動設定)
	...
	//------------------------------
            ...
            sw.WriteLine();
			sw.WriteLine("; Ai。(0: OFF, 1: ON)");
			sw.WriteLine("; Use pre-textures render.");
			sw.WriteLine("{0}={1}", nameof(Ai), Ai ? 1 : 0);
			#endregion
			#region [ Window関連 ]
								...
								switch( unknown )
								{
									...
									case Eセクション種別.System:
										...
										//----------------------------------------
											...
											{
												this.nInputAdjustTimeMs = C変換.n値を文字列から取得して範囲内に丸めて返す( str4, -99, 1000, this.nInputAdjustTimeMs );
											}
											else if ( str3.Equals( "JudgeLinePosOffsetDrums" ) )		// #31602 2013.6.23 yyagi
											{
												this.nJudgeLinePosOffset.Drums = C変換.n値を文字列から取得して範囲内に丸めて返す( str4, -99, 1000, this.nJudgeLinePosOffset.Drums );
											}
											else if ( str3.Equals( "JudgeLinePosOffsetGuitar" ) )		// #31602 2013.6.23 yyagi
											{
												this.nJudgeLinePosOffset.Guitar = C変換.n値を文字列から取得して範囲内に丸めて返す( str4, -99, 1000, this.nJudgeLinePosOffset.Guitar );
											}
											else if ( str3.Equals( "JudgeLinePosOffsetBass" ) )			// #31602 2013.6.23 yyagi
											{
												this.nJudgeLinePosOffset.Bass = C変換.n値を文字列から取得して範囲内に丸めて返す( str4, -99, 1000, this.nJudgeLinePosOffset.Bass );
											}
									...
									case Eセクション種別.PlayOption:
										{
                                            ...
                                            */
											...
											{
												this.n譜面スクロール速度.Drums = C変換.n値を文字列から取得して範囲内に丸めて返す( str4, 0, 1000, this.n譜面スクロール速度.Drums );
											}
