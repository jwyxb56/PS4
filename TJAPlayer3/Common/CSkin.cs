...
//                    }
        ...
        #region 背景(スクロール)
        public int[] Background_Scroll_Y = new int[] { 0, 540 };
        #endregion
        ...
        #endregion
        #region SongLoading
        public int[] SongLoading_Plate_XY = new int[] { 960, 540 };
        ...
        public int Game_Bar_Height = 240;
        #region Chara
        public int[] Game_Chara_X = new int[] { 257, 0 };
        public int[] Game_Chara_Y = new int[] { 69, 537 };
        public int[] Game_Chara_Balloon_X = new int[] { -60, -60, 0, 0 };
        public int[] Game_Chara_Balloon_Y = new int[] { 0, 210, 0, 0 };
        ...
        #endregion
        #region CourseSymbol
        public int[] Game_CourseSymbol_X = new int[] { 25, 64 };
        public int[] Game_CourseSymbol_Y = new int[] { 300, 432 };
        #endregion
        #region PanelFont
        public int[] Game_MusicName_XY = new int[] { 1805, 20 };
        public int[] Game_Genre_XY = new int[] { 1540, 105 };
        public int[] Game_Lyric_XY = new int[] { 640, 630 };
        public int Game_MusicName_FontSize = 40;
        ...
        #endregion
        #region Score
        public int[] Game_Score_X = new int[] { 100, 20, 0, 0 };
        public int[] Game_Score_Y = new int[] { 522, 530, 0, 0 };
        public int[] Game_Score_Add_X = new int[] { 135, 20, 0, 0 };
        public int[] Game_Score_Add_Y = new int[] { 476, 570, 0, 0 };
        public int[] Game_Score_AddBonus_X = new int[] { 20, 20, 0, 0 };
        public int[] Game_Score_AddBonus_Y = new int[] { 136, 626, 0, 0 };
        public int Game_Score_Padding = 30;
        public int[] Game_Score_Size = new int[] { 35, 47 };
        #endregion
        #region Taiko
        public int[] Game_Taiko_Background_X = new int[] { -54, 0 };
        public int[] Game_Taiko_Background_Y = new int[] { 324, 360 };
        public int[] Game_Taiko_Frame_X = new int[] { 498, 329 };
        public int[] Game_Taiko_Frame_Y = new int[] { 203, 360 };
        public int[] Game_Taiko_NamePlate_X = new int[] { 68, 0 };
        public int[] Game_Taiko_NamePlate_Y = new int[] { 290, 368 };
        public int[] Game_Taiko_PlayerNumber_X = new int[] { 4, 4 };
        public int[] Game_Taiko_PlayerNumber_Y = new int[] { 233, 435 };
        public int[] Game_Taiko_X = new int[] { 264, 185 };
        public int[] Game_Taiko_Y = new int[] { 446, 366 };
        public int[] Game_Taiko_Combo_X = new int[] { 268, 268 };
        public int[] Game_Taiko_Combo_Y = new int[] { 271, 448 };
        ...
        public int[] Game_Taiko_Combo_Padding_Ex = new int[] { 28, 30, 24 };
        public int[] Game_Taiko_Combo_Padding_SPE = new int[] { 28, 30, 24 };
        public int[] Game_Taiko_Combo_Size = new int[] { 63, 72 };
        public int[] Game_Taiko_Combo_Size_Ex = new int[] { 74, 84 };
        public int[] Game_Taiko_Combo_Size_Super_Hyper_Ex = new int[] { 70, 114 };
        public float[] Game_Taiko_Combo_Scale = new float[] { 1.0f, 1.0f, 0.8f };
        public float[] Game_Taiko_Combo_Scale1 = new float[] { 1.0f, 1.0f, 0.8f };
        public int[] Game_Taiko_Combo_Text_X = new int[] { 267, 268 };
        public int[] Game_Taiko_Combo_Text_Y = new int[] { 292, 472 };
        public int[] Game_Taiko_Combo_Text_Size = new int[] { 100, 50 };
        public bool Game_Taiko_Combo_Ex_IsJumping = true;
        #endregion
        #region Gauge
        public int[] Game_Gauge_X = new int[] { 814, 492 };
        public int[] Game_Gauge_Y = new int[] { 369, 532 };
        public int Game_Gauge_Rainbow_Ptn;
        public int Game_Gauge_Rainbow_Timer = 50;
        #endregion
        #region Balloon
        public int[] Game_Balloon_Combo_X = new int[] { 385, 253 };
        public int[] Game_Balloon_Combo_Y = new int[] { 28, 498 };
        ...
        public int[] Game_Balloon_Balloon_X = new int[] { 600, 382 };
        public int[] Game_Balloon_Balloon_Y = new int[] { 172, 290 };
        ...
        #endregion
        #region Effects
        public int[] Game_Effect_Roll_StartPoint_X = new int[] { -50, -40, -140, -70, -120, -90, -100, -50, -40, -50, -70, -150 };
        public int[] Game_Effect_Roll_StartPoint_Y = new int[] { 75, 150, 175, 230, 560, 575, 635, 690, 790, 850, 920};
        public int[] Game_Effect_Roll_StartPoint_1P_X = new int[] { 56, -10, 200, 345, 100, 451, 600, 260, -30, 534, 156, 363 };
        public int[] Game_Effect_Roll_StartPoint_1P_Y = new int[] { 75, 150, 175, 230, 560, 575, 635, 690, 790, 850, 920 };
        ...
        public int[] Game_Effect_GoGoSplash = new int[] { 450, 600, 30 };
        public int[] Game_Effect_GoGoSplash_X = new int[] { 180, 450, 780, 1140, 1470, 1740 };
        public int[] Game_Effect_GoGoSplash_Y = new int[] { 1110, 1095, 1080, 1080, 1095, 1110 };
        public bool Game_Effect_GoGoSplash_Rotate = true;
        public int Game_Effect_GoGoSplash_Timer = 18;
        // super-flying-notes AioiLight
        public int[] Game_Effect_FlyingNotes_StartPoint_X = new int[] { 620, 414 };
        public int[] Game_Effect_FlyingNotes_StartPoint_Y = new int[] { 612, 434 };
        public int[] Game_Effect_FlyingNotes_EndPoint_X = new int[] { 1788, 1222 }; // 1P, 2P
        public int[] Game_Effect_FlyingNotes_EndPoint_Y = new int[] { 330, 554 };

        public int Game_Effect_FlyingNotes_Sine = 290;
        ...
        //Xは中央基準描画、Yは左上基準描画
        public bool Game_LaneAuto = true;
        public int[] Game_Lane_Field_X = new int[] { 621, 414 };
        public int[] Game_Lane_Field_Y = new int[] { 430, 368 };
        //中心座標指定
        public int[] Game_Lane_JudgePoint_X = new int[] { 618, 618, 618, 618 };     //これ使われてないな(rhimm)
        ...
        //左上基準描画
        public int[] Game_Lane_Background_X = new int[] { 456, 498, 498, 498 };
        public int[] Game_Lane_Background_Y = new int[] { 420, 368, 0, 0 };
